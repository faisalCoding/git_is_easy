...
بالنسبة للمكون الاول سناوضحها لك بالتشجير التالي
```
commit
...
اذا لنقوم بعمل مكون الاول tree [main project folder] 
...
‏واحد من هذه ال`objects` هو ال ` tree [main project folder] `  الفارغة التي شهدناها سابقا والآخر هو ال `blob` الخاص بملف `home_page.html`  
