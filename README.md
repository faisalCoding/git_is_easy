...
```
 ...
 ‏هذا المجلد سيكون المجلد الرئيسي للمشروع مجلد `root` للمشروع والذي سوف يتتبع git كل الملفات و المجلدات حسب الحالات الأربع التي ذكرناها سابقا
[الحالات الأربع التي ذكرناها سابقا](###_كيف_يعمل؟)
