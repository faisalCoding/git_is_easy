...
‏وليس فقط الأرض متعلق بالمشاكل التي قد تحدث لبرنامج أثناء تطويره ولكن هناك حالات أخرى مثل إضافة ميزة جديدة أو تحسين كود ما ويعاد كتابة بشكل أفضل
‏وعلى طبيعة الحال فإن هذه الاسطر البرمجية (`content`) تكتب داخل ملفات (`file`) وهذه الملفات لابد أن تكون داخل مجلد (`folder`)
...
```
object/
  ├── blob ---> // files and content this file 
  ├── tree ---> // folders -> has files and folders
  ├── commit -> // snapshot for the main project tree 
  .
  .
  .
```
